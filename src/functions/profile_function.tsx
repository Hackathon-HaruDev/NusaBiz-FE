...
export const ProfileFunction = () => {
        ...
        const fetchInitialData = async () => {
            try {
                ...
                const mappedUser = {
                    ...
                    profileImage: userData.image || 'https://placehold.co/400x400/cccccc/333333?text=N/A'
                };
    ...
    useEffect(() => {
        ...
        const isUserDataChanged = (userFormData.fullName !== initialUser.fullName ||
                                   userFormData.whatsappNumber !== initialUser.whatsappNumber);
        
        const isBusinessDataChanged = (businessFormData.businessName !== initialBusiness.businessName ||
    ...
    const handleSaveChanges = async (e: React.FormEvent) => {
        ...
        if (isBusinessDataChanged && initialBusiness.businessId) {
             updatePromises.push(
                APICall(`/businesses/${initialBusiness.businessId}`, 'PUT', businessPayload)
                    .then(data => {
                        console.log("SUCCESS: Business Info Updated");
        ...
        if (isPasswordChanged) {
            ...
            updatePromises.push(
                APICall('/users/me/password', 'PUT', { currentPassword: oldPassword, newPassword: newPassword })
                    .then(() => {
