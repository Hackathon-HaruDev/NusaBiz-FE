...
const Riwayat:React.FC<props> = ({data}) => {
    ...
    return(
        <div className="flex flex-row gap-4 p-5 items-center border-b border-[#e5e5e5] cursor-pointer">
            <div className={`${data.tipe === "Pemasukan" ? "bg-[#3ED750]/35": "bg-[#D73E3E]/35"} p-3 rounded-lg`}>
                {
                    data.tipe === "Pemasukan" ? <ShoppingBagIcon className="text-[#35A042]"/> : <DollarSignIcon className="text-[#C63939]" />
                }
            </div>
